...
object uranus extends VSOPDataset {
  override val lat: Latitude = data.uranus.lat
  override val long: Longitude = data.uranus.long
  override val rad: Radius = data.uranus.rad
